...
def getData(data, years, months):
    ...
    s = 3
    data = gaussian_filter(data, sigma = s)#, truncate = (((interval - 1) / 2) - 0.5) / 3)
...
data = getData(data, [1878, 1926, 1933, 1942, 1995, 1998, 2005, 2010, 2020], months)# - getData(data, atlnina, months)
...
ax.set_title(f'2024 Hurricane Season Analogs', fontsize=9, loc='center') 
...
plt.savefig(r"C:\Users\deela\Downloads\2024trackdensityanalogs.png", dpi = 400, bbox_inches = 'tight')
plt.show()