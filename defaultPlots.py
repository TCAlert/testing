...
def scatter(x, y, title = None, z = None):    
    ...
    plt.savefig(f"C:\Users\deela\Downloads\scatter{x[0]}/{y[0]}.png", dpi = 400, bbox_inches = 'tight')
    plt.show()
...
def histogram(data, bounds = None, title = None):
    ...
    plt.savefig(f"C:\Users\deela\Downloads\histogram_{data[0]}.png", dpi = 400, bbox_inches = 'tight')
    plt.show()