...
c = plt.pcolormesh(grid1, grid2, data, cmap = cmap.probs(), norm = PiecewiseNorm([0.1, -0.05, 0.01, -0.005, 0, 0.005, 0.01, 0.05, 0.1]))
cbar = plt.colorbar(c, orientation = 'vertical', aspect = 50, pad = .02)
cbar.ax.tick_params(axis='both', labelsize=9, left = False, bottom = False)
ax.set_title(f'TC-RADAR: Normalized Tilt {t} CFAD\nVertical Velocity (>50% Valid Points)', fontweight='bold', fontsize=9, loc='left')
