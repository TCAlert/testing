...
# print(set(dataset.where(dataset.system_type.isin(['']), drop=True).atcf.values))
...
for i in range(numOfEOFS):
    ...
    # mean.append(m)
    # std.append(s)
    test = (newArray.reshape(len(newArray), 28)).dot(pca.components_[i].T).squeeze()
    ...
    plt.savefig(r"C:\Users\deela\Downloads\EOFS\hodo" + str(i + 1) + ".png", dpi = 400, bbox_inches = 'tight')
    #plt.show()
...
# dataset = xr.open_dataset(r"C:\Users\deela\Downloads\SHEARS_1987-2021.nc")
