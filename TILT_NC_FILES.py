...
meanOX = data['obsx'].mean('case')
meanOY = data['obsy'].mean('case')

meanCX = data['climoXsv'].mean('case')
meanCY = data['climoYsv'].mean('case')

meanMX = data['predx_mean'].mean('case')
meanMY = data['predy_mean'].mean('case')
...
plt.savefig(r"C:\Users\deela\Downloads\tiltValueAllNOSHRROTATIONc.png", dpi = 400, bbox_inches = 'tight')
plt.show()